...
import aisha.geolocationapp.BuildConfig;
import aisha.geolocationapp.R;


public class AboutusFragment extends Fragment implements OnCompleteListener<Void> {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Get the UI widgets.
        mAddGeofencesButton = view.findViewById(R.id.add_geofences_button);
        mRemoveGeofencesButton = view.findViewById(R.id.remove_geofences_button);
